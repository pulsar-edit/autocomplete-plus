...
import {waitForAutocomplete, triggerAutocompletion, conditionPromise, waitForAutocompleteToDisappear} from './spec-helper'
...
describe('Provider API', () => {
  ...
  describe('Provider API v5.0.0', () => {
    ...
    fit('replaces the right range on the editor when `range` is present', async () => {
      testProvider = {
        scopeSelector: '.source.js',
        filterSuggestions: true,
        getSuggestions (options) {
